...
下载本工程，并且增加如下代码到rc.local

~~~shell
brew install heroku
heroku config -a yy-shadowsocks -j
# checkout the KEY and METHOD
node local.js -s yy-shadowsocks.herokuapp.com -l 1080 -m METHOD -k KEY -r 80
~~~
